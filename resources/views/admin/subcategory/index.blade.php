...
<div class="p-4 bg-gray-900 md:rounded">
    ...
    <div class="p-4 md:rounded bg-gray-800 mb-2">
        <h3 class="font-serif font-semibold text-lg text-gray-100 leading-tight">
            All Sub Categories Information
        </h3>
        <p class="text-sm text-gray-300 leading-tight mt-1 mb-2">
            Review and update each sub category's information, add new sub category or delete.
        </p>
    </div>
    <!-- table -->
                        ...
                        <tr class="font-light">
                            ...
                            <td class="rounded-lg bg-gray-800 border-2 border-gray-700">
                                <div class="flex justify-around content-center flex-wrap">
                                    @auth('admin')
                                    <form action="{{route('admin.subcategory.edit', $cat->id)}}" method="GET">
                                    ...
                                    <form action="{{route('admin.subcategory.delete', $cat->id)}}" method="POST" class="mr-1">
    ...
    <div class="p-4 md:rounded bg-gray-800 mb-2">
        ...
        <p class="text-sm text-gray-300 leading-tight mt-1 mb-2">
            Add new sub category to one of the categories.
        </p>
    </div>
    <div class="p-4 md:rounded bg-gray-700">
        <form action="{{ route('store.subcategory') }}" method="POST" class="w-full">
            @csrf
